...
In addition to source code control I am using GitHub for both [Bug Tracking](http://github.com/jaredpar/VsVim/issues) and a [FAQ](http://wiki.github.com/jaredpar/VsVim/faq). Bug tracking is open to the public so please file any issues or feature requests there.
...
Source for this release is available on the GitHub project site. It and the associated binaries are released under the [MS-PL](http://msdn.microsoft.com/en-us/library/cc707818.aspx).
